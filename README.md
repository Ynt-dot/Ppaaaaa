...
- Исправить регистрацию по электронной почте
    - Сделать так, чтобы нельзя было зарегестрировать два аккаунта на одну почту
    - Добавить "показать пароль"
    - Перевести на русский экран требований на странице регистрации
...
- Добавить зеркало мультов с других сервисов (Вот ссылки на сайты для рисования Мультатор, Лонети, Рисовакула и  - https://multator.ru, https://loneti.ru/, https://smigames.ru/risovakula/info)
- Добавить ранги
- Добавить медали
