...
- Через редактирование можно сделать аватарку больше 10 кадров
- Исправить ошибку загрузки при выборе аватарки
- А нужны ли нам круглые аватарки? Если нужны, то надо хотя-бы дать возможность обрезать аватарку правильным образом
- Добавить настройки
  - Изменение пароля
  - Изменение ника
  - ЧС
