...
- Сделать перенаправление с ppaaaaa.online на ppaaaaa.ru
- Убрать кнопку показа пароля из регистрации (она там итак есть, для встроенной кнопки сделать так, чтобы он показывалась всегда)
- Добавить надпись "бета" в лого
