...
- Улучшить редактор
  - Сделать так, чтобы в редакторе при добавлении кадра предыдущий выбранный кадр сохранялся в описании действия в history и при отмене действия добавления кадра если действующим кадром является кадр, который уже не существует, действующий кадр переключался бы на предыдущий действующий, а не оставался бы на несуществующем кадре.
  - Сделать Горячие клавиши на добавление и удаление кадра
  - Сделать проигрывание рисования статичных артов на странице мульта
- Изменить цвета Дискорд-виджета
