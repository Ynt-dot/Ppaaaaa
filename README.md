...
- Добавить логи
- Добавить тесты
- Добавить возможность смотреть IP аккаунтов и собирать, чтобы банить по IP
...
- Добавить шрифт как на мультаторе ([вот пример](https://web.archive.org/web/20211024192200/https://multator.ru/wiki/%D0%9F%D0%B0%D1%83%D1%87%D0%BA%D0%B8))
- Добавить темы дня
- Добавить ЛС
