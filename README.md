...
- Улучшить редактор
- Добавить мульт-уроки и folioscope в список конкурентов
- Заменить название заглавной со "Все мультики" на "Ппааааа"
- Добавить контейнер
- Подключить debug_toolbar
- Добавить виджеты Гитхаба и Бусти
- Добавить кнопку показа пароля при авторизации (а не только регистрации)
- Сделать ограничение на количество кадров в гифке на главном экране
- Привести сайт к цветовой палитре: чёрный, белый, красный, зелёный.
