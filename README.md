...
ОБНОВЛЕНИЕ НА СЕРВЕРЕ В ПАПКЕ ДОМЕНА (ВНИМАНИЕ! ИНСТРУКЦИЯ НЕ АКТУАЛЬНА! ТРЕБУЕТ ДОРАБОТКИ! ИСПОЛЬЗУЙТЕ В СОЧЕТАНИИ С https://help.reg.ru/support/hosting/php-asp-net-i-skripty/kak-ustanovit-django-na-hosting#1):
...
- Исправить регистрацию по электронной почте
    ...
    - Перевести экран требований на странице регистрации
