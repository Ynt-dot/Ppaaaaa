...
- Раздел комментариев на личной странице немного сломан по дизайну
- Комментарии пользователя на личной странице (раздел комментариев), почему-то, долго загружаются (разобраться почему)
