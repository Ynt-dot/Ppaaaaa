...
- При смене аватарки на личной странице в разделе комментариев, аватарки на комментариях не обновляются.
- Переделать ветки комментариев (добавить полосу справа, сделать табуляцию меньше, сделать поддержку большего уровня вложенностей на одной странице, сделать загрузку большего кол-ва коммов одного уровня без загрузки коммов сл. уровня без запроса (как в ВК))
