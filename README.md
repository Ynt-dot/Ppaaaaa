...
4. Чтобы увидеть изменения, вам необходимо перезапустить проект. Для этого создайте файл **.restart-app** в корневой директории вашего сайта (touch .restart-app). После перезапуска проекта файл будет удалён автоматически.
