...
- Поправить стили кнопок в разделе "Ссылки"
- Позволить действующую аватарку устанавливать как аватарку со страницы мульта (Для повторной обрезки)
- В окне "Выбрать аватар" длинные названия мультов не обрезаются. Надо сделать обрезку + всплывающую подсказку как с превью
