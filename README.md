...
- Фраза "Войдите, чтобы ставить лайки" должна появляться слева от кнопки лайка
- Сделать свёртку длинных комментариев
- Система ответов на комметарии как на Реддите
- Сделать на главной для авторизованных пользователей по умолчанию сортировкой тренды
- Сделать сохранение выбора сортировки на главной странице для авторизованных пользователей
- В редакторе сделать полоноэкранный режим
- Увеличить размер аватарок в комментариях
- Позволить обрезать аватарки как надо
- Добавить настройки
  - Изменение пароля
  - Изменение ника
  - ЧС
